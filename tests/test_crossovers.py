...
class G1DBinaryStringCrossoversTestCase(CrossoverTestCase):
    ...
    def test_single_point(self, rand_mock):
        ...
        self.assertCrossoverResultsEqual(
            Crossovers.G1DBinaryStringXSinglePoint, [1, 0, 1], [0, 0, 0], crossover_extra_kwargs={"count": 2}
        )

        self.assertCrossoverResultsEqual(
            Crossovers.G1DBinaryStringXSinglePoint, [1, 0, 1], None, crossover_extra_kwargs={"count": 1}
        )
    ...
    def test_two_point(self, rand_mock):
        rand_mock.return_value = 1
        self.assertCrossoverResultsEqual(
            Crossovers.G1DBinaryStringXTwoPoint, [1, 0, 0], [0, 0, 1], crossover_extra_kwargs={"count": 2}
        )

        self.assertCrossoverResultsEqual(
            Crossovers.G1DBinaryStringXTwoPoint, [1, 0, 0], None, crossover_extra_kwargs={"count": 1}
        )
...
class G1DListCrossoversTestCase(CrossoverTestCase):
    ...
    def test_single_point(self, rand_mock):
        rand_mock.return_value = 1
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverSinglePoint, [1, 5, 6], None, crossover_extra_kwargs={"count": 1}
        )
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverSinglePoint, [1, 5, 6], [4, 2, 3], crossover_extra_kwargs={"count": 2}
        )
    ...
    def test_two_points(self, rand_mock):
        rand_mock.return_value = 1
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverTwoPoint, [1, 2, 3], None, crossover_extra_kwargs={"count": 1}
        )
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverTwoPoint, [1, 2, 3], [4, 5, 6], crossover_extra_kwargs={"count": 2}
        )
    ...
    def test_order_crossover(self, rand_mock):
        ...
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverOX, [1, 2, 3], None, crossover_extra_kwargs={"count": 1}
        )
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverOX, [1, 2, 3], [4, 5, 6], crossover_extra_kwargs={"count": 2}
        )
    ...
    def test_crossfill_crossover(self, rand_mock):
        rand_mock.return_value = 1
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverCutCrossfill, [1, 4, 5], None, crossover_extra_kwargs={"count": 1}
        )
        self.assertCrossoverResultsEqual(
            Crossovers.G1DListCrossoverCutCrossfill, [1, 4, 5], [4, 1, 2], crossover_extra_kwargs={"count": 2}
        )
